...
# --- Save NPZ ---
npz_file = os.path.join(output_dir, "era5_auro_drwb_mse_ste_rmse_highres_dict.npz")
...
plt.ylabel("RMSE")
plt.title("ERA5 vs Aurora: Surface Temperature Energy 0.1 degrees (SEA Region)")
plt.grid(True)
plot_file = os.path.join(output_dir, "era5_auro_drwb_mse_ste_highres_rmse.png")
